...
run {
    ...
    // Spacer 64dp để CÁCH RẤT XA nút Áp dụng
    content.addView(
    ...
    // Divider 1dp mờ phía trên footer (có marginTop 12dp)
    ...
    // Helper căn giữa CHẮC CHẮN cho từng TextView
    fun android.widget.TextView.center() {
